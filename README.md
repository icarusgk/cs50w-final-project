...
| `AppProjects.vue`          | The component that shows the `ITask`, the page count, iterates over the projects and shows the pagination component.                                                                                                                                                                                                                         |
...
| `AppTasks.vue`             | The component that shows the `ITask`, the page count, iterates over the tasks and shows the pagination component.                                                                                                                                                                                                                            |
